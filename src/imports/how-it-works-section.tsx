...
- [ ] Step 1 bubble is pink, shows invite link mockup card with Copy Link button
- [ ] Step 2 bubble is purple, shows `appScreenshot` image with Letterboxd italic note above it
- [ ] Step 3 bubble is blue, shows `matchesScreenshot` image with "No more endless scrolling" italic note below
