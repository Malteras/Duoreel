...
// The three curated sections in Discover ("Because you saved X", "Trending this week", "Hidden gems")
// were updated in QUI-221 to use CompactMovieCard instead, for visual consistency with Saved/Matches tabs.
