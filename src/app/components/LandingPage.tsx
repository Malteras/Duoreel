    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-20 sm:py-32">
        ...
        <div className="max-w-4xl mx-auto mb-32 relative">
          ...
          <div className="absolute -left-32 top-20 w-72 h-72 bg-blue-500/10 rounded-full blur-3xl pointer-events-none" />
          <div className="absolute -right-32 top-80 w-72 h-72 bg-purple-500/10 rounded-full blur-3xl pointer-events-none" />
